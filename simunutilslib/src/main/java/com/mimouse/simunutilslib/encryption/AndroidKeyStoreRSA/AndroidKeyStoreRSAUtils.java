package com.mimouse.simunutilslib.encryption.AndroidKeyStoreRSA;
...
import com.mimouse.simunutilslib.encryption.androidkeystoresign.SecurityConstants;
...
public class AndroidKeyStoreRSAUtils {
    ...
    public static PrivateKey getPrivateKey(String privateKeyData) {
        ...
        try {
            byte[] decodeKey = new BASE64Decoder().decodeBuffer(privateKeyData);
                    //Base64Decoder.decodeToBytes(privateKeyData);
    ...
    public static PublicKey getPublicKey(String publicKeyData) {
        ...
        try {
            byte[] decodeKey = new BASE64Decoder().decodeBuffer(publicKeyData);
