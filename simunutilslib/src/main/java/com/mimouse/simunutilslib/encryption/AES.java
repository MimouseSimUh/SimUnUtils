...
public class AES {
    private  final String encryptEncodeRules = "knight";//定义默认加密规则
     ...
     * 6.返回字符串
     */
    public  String invokeEncryptEncode(String content,String password) {
        String resultEncode = "";
        try {
            ...
            //[11].将字符串返回
            return resultEncode;
        } catch (NoSuchAlgorithmException | NoSuchPaddingException | InvalidKeyException | IllegalBlockSizeException | UnsupportedEncodingException | BadPaddingException exception) {
     ...
     * 3.将加密内容解密
     */
    public  String invokeDecryptEncode(String content,String password) {
        String resultEncode = "";
        try {
            /**
             * //[1].利用KeyGenerator构造密钥生成器，指定为AES算法，不区分大小写
